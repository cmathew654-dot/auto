...
- [x] **DEMO-07**: Destination panel uses neutral styling with no eMoney branding, logo, colors, or page title
- [x] **DEMO-08**: Clicking Save in the destination panel confirms the operator's action locally and never implies a real eMoney save
