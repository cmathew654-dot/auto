...
export function installRegulatedLedgerStyles(): void {
  ...
  style.textContent = `
    ...
    :root {
      ...
      --sans-text: Roboto, "Helvetica Neue", Arial, sans-serif;
