...
export function installRegulatedLedgerStyles(): void {
  ...
  style.textContent = `
    :root {
      ...
      --accent-line: oklch(0.78 0.045 255);
    ...
    * { box-sizing: border-box; }
    ...
    body {
      ...
      background-image:
        repeating-linear-gradient(
          to bottom,
          oklch(0.20 0.012 250 / 0.035),
          oklch(0.20 0.012 250 / 0.035) 1px,
          transparent 1px,
          transparent 32px
        ),
        linear-gradient(
          to right,
          transparent 71px,
          oklch(0.20 0.012 250 / 0.05) 71px,
          oklch(0.20 0.012 250 / 0.05) 73px,
          transparent 73px
        );
    ...
    .ledger-actions-stacked {
      display: grid;
      gap: var(--s-2);
    }

    .ledger-file-input-hidden {
      position: absolute;
      width: 1px;
      height: 1px;
      padding: 0;
    ...
    .ledger-check:nth-child(2n) { border-right: 0; }
    .ledger-check:nth-last-child(-n+2) { border-bottom: 0; }
    ...
    .ledger-button:hover {
      background: oklch(0.38 0.075 255);
      border-color: oklch(0.38 0.075 255);
    }
